...
namespace Projet_C_
{
    ...
    {
        OleDbConnection cnn = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.16.0;Data Source=\"C:\\Users\\User\\Desktop\\Projetc#\\BD_C#.accdb\";");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (comboBox1.SelectedIndex >= 0)
            {
                if (dataGridView1.SelectedRows.Count > 0)
                {
                    ...
                    OleDbCommand oleDbCommand = new OleDbCommand(req, cnn);
        ...
        private void comboBox1_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            ...
            OleDbCommand cmd2 = new OleDbCommand(req2, cnn);
