    ...
    public partial class SIGN_UP_medcin : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (rd != null)
                {
                    string req1 = "select * from  medcin where login ='" + textBox2.Text + "";
                    OleDbCommand cmd1 = new OleDbCommand(req1, connection);
                    ...
                    {
                        string req2 = "update medcin set login ='" + textBox2.Text + "', mot_de_passe ='" + textBox3.Text + "' where Email ='" + textBox1.Text + "'";
        ...
        private void SIGN_UP_medcin_Load(object sender, EventArgs e)
        {
