    ...
    public partial class Gerer_rendez_vous: Form
    {
      ...
      int id_medcin, id_patient;
        ...
        private void Gerer_rendez_vous_Load(object sender, EventArgs e)
        {
            ...
            if (exist)
            {
                hist = new OleDbDataAdapter("select numero_rendez_vous, date_rendez_vous from rendez_vous where id_patient = " + id_patient + " and id_medcin ="+id_medcin+ " and etat ='Terminer'  order by date_rendez_vous", DataBase.connection);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DataBase.connection.Open();
                ...
                OleDbCommand cmd2=new OleDbCommand(req, DataBase.connection);
