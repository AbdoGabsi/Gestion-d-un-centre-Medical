...
namespace Gestion_Intelligente_d_un_Centre_Médical
{
    public partial class CRUD_Admin: Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            daPatient = new OleDbDataAdapter("select * from patient", DataBase.connection);
            ...
            daMedcin = new OleDbDataAdapter("select * from medcin", DataBase.connection);
            daMedcin.Fill(ds, "Medcin");
            cbM = new OleDbCommandBuilder(daMedcin);
            //Ajouter la table sécritaire
            daSecretaire = new OleDbDataAdapter("select * from secretaire", DataBase.connection);
            ...
            else if (comboBox1.SelectedIndex == 2)
            {
                ...
                if (!existe)
                {
                    ...
                    else
                    {
                        ...
                        DataBase.connection.Open();
                        OleDbCommand cmd = new OleDbCommand("select * from specialité", DataBase.connection);
                        ...
                        comande = new OleDbCommand(req, DataBase.connection);
                        ...
                        foreach (string jour in joursSemaine)
                        {
                            ...
                            cmd2 = new OleDbCommand(req2, DataBase.connection);
