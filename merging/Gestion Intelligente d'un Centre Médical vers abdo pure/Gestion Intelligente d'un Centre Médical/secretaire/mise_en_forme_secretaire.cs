...
{
    public partial class mise_en_forme_secretaire : Form
    {
        public static Panel pnl;
        private int idMed;
        private string pseudo;
        public mise_en_forme_secretaire(int id_med,string pseudo)
        {
            InitializeComponent();
            pnl = panel4;
            this.idMed = id_med;
        ...
        private void mise_en_forme_secretaire_Load(object sender, EventArgs e)
        {
